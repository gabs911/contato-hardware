...
serialPort = serial.Serial(port = "COM14", baudrate=115200, bytesize=8, timeout=2, stopbits=serial.STOPBITS_ONE)
serialString = ''
...
#Comentar nas saidas miiidiout para desativar o touch
    ...
    if(accel > 5000 and (time.time() - previousSoundEffectActiv >= soundeEffectInterval)):
        ...
        midiout.send_message([0x91,94,120]) #parametro da nota segundo numero do midiout.sed_message
